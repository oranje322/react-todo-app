...
const ListItem = ({name, color, id, onClickListItem, index, isActive, onDeleteItemList}) => {
    ...
    return (
<Link to={`/${id}`}>
        <div onClick={onClick} className={cn('listItem', {active: isActive})}>
            ...
            <svg onClick={onClickDeleteItem} width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
