...
import {deleteItemsList, setItemsList, reducer, setActiveItemList, showAllTasks} from "../../Redux/Reducers/reducer";
...
const Sidebar = () => {
    ...
    return (
        <div className={'todo__sidebar'}>
            <div className="list">
                <div onClick={onClickAllTasks} className="list__header">
